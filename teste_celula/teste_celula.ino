...
//#define USE_ETHERNET_SHIELD
  ...
  #error "Uncomment the #define for either USE_WIFI101_SHIELD or USE_ETHERNET_SHIELD"
    ...
    // Use WiFi
      ...
      #include <WiFi101.h>
    #endif
    char ssid[] = "CEI";    //  your network SSID (name) 
    char pass[] = "#CEI-ufg16%";   // your network password
...
/*
  ...
  *****************************************************************************************/
unsigned long myChannelNumber = 352485;
const char * myWriteAPIKey = "GI021A2YWASN004U";
...
void loop() {
  ...
  pinVoltage = pinVoltage*1000;  
  pinVoltage = map(pinVoltage,0,1000,0,5000);
  pinVoltage = pinVoltage/100;
  Serial.println(pinVoltage);
  ThingSpeak.setField(3,pinVoltage);
//  pinVoltage = analogRead(A0) * (VOLTAGE_MAX / VOLTAGE_MAXCOUNTS);
